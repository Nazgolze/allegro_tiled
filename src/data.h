...
struct _ALLEGRO_MAP
{
	...
	SList *layers;              // list of all layers
	SList *tile_layers;         // list of tile layers
	SList *object_layers;       // list of object layers
	SList *tilesets;            // list of tilesets
	int tile_layer_count;       // number of tile layers
	int object_layer_count;     // number of object layers
	RBTree *tiles;              // full list of tiles
};
...
struct _ALLEGRO_MAP_LAYER
{
	...
	SList *objects;						 // objects (object layer only)
	int object_count;					 // number of objects (object layer only)
	RBTree *properties;				 // properties
};
...
struct _ALLEGRO_MAP_TILE
{
	...
	RBTree *properties;					 // tile properties
